...
export class RunBacktestDto {
  ...
  @IsEnum(['ema_cross', 'rsi_reversion', 'smc_bos', 'cyclical_extreme', 'grid_369', 'live_smc', 'live_sk', 'live_ict'])
  strategy: 'ema_cross' | 'rsi_reversion' | 'smc_bos' | 'cyclical_extreme' | 'grid_369' | 'live_smc' | 'live_sk' | 'live_ict';
